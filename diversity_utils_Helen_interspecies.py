...
def calculate_unbiased_sigmasquared(allele_counts_1, allele_counts_2):
    ...
    print("genotypes")
    print(genotypes_1) #<==================================== matrix of 0s and 1s
    print(len(genotypes_1)) #<=============================== 18
    print(len(genotypes_1[0])) #<============================ 54

    print("passed sites")
    print(passed_sites_1) #<================================= matrix os True's and False's 
    print(len(passed_sites_1)) #<============================ 18
    print(len(passed_sites_1[0])) #<========================= 54
    
    
    # this asks which pairs of sites have depths >0 at BOTH sites
    # None here takes the product of the elements in the two vectors and returns a matrix. 
    joint_passed_sites = (passed_sites_1)[None,:,:]*(passed_sites_2)[:,None,:]
    print("joint_passed_sites")
    print(joint_passed_sites)
    # sites x sites x samples matrix
    ...
    # print(len(joint_passed_sites)) <======================== 18
    # print(len(joint_passed_sites[0])) <===================== 18
    # print(len(joint_passed_sites[0][0])) <================== 54

    # print(ns) # <============================================= 18x18 matrix of counts (collapsed joint_passed_sites, summing on all 54 samples for each pair of gene)
    ...
    # print(allele_frequency_1)
    # input("yessss")
    
    rsquared_numerators = rsquared_numerators*(ns>3.5)*1.0/(ns*(ns-1)*(ns-2)*(ns-3)+10*(ns<3.5)) #orginal code
    # rsquared_numerators = rsquared_numerators*(ns>3.5)*(allele_frequency_1 >= 0.3)*(allele_frequency_1 <= 0.7)*(allele_frequency_2 >= 0.3)*(allele_frequency_2 <= 0.7)*1.0/(ns*(ns-1)*(ns-2)*(ns-3)+10*(ns<3.5))
    ...
    rsquared_denominators = rsquared_denominators*(ns>3.5)*1.0/(ns*(ns-1)*(ns-2)*(ns-3)+10*(ns<3.5)) #origial
    # rsquared_denominators = rsquared_denominators*(ns>3.5)*(allele_frequency_1 >= 0.3)*(allele_frequency_1 <= 0.7)*(allele_frequency_2 >= 0.3)*(allele_frequency_2 <= 0.7)*1.0/(ns*(ns-1)*(ns-2)*(ns-3)+10*(ns<3.5))
