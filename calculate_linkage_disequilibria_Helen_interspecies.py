...
if __name__=='__main__':
    ...
    good_species_list=['Bacteroides_vulgatus_57955', 'Prevotella_copri_61740'] # comment out this line after debugging
            ...
            for clade_type in clade_types:
                ...
                for variant_type in variant_types:
                    ...
                    for gene_name in allele_counts_map.keys():
                        ...
                        allele_counts_1 = allele_counts_map1[gene_name_1][variant_type]['alleles']
                        allele_counts_2 = allele_counts_map2[gene_name_2][variant_type]['alleles']
                        ...
                        if clade_type=='largest_clade':        
                            ...
                            allele_counts_1 = allele_counts_1[:,largest_clade_idxs,:]
                            allele_counts_2 = allele_counts_2[:,largest_clade_idxs,:]
